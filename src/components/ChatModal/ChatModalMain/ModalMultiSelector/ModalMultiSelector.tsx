...
import s from "./ModalMultiSelector.module.scss";
...
export const ModalMultiSelector = () => {
    ...
    <>
      <ul className={s.chat_modal_main__list}>
        <li
          ...
          className={classNames(s.chat_modal_main__list_item, {
            [s.chat_modal_main__list_item__selected]:
              selectedItem === SelectedItem.Media,
          })}
        >
          Media
        </li>
        ...
        <li
          ...
          className={classNames(s.chat_modal_main__list_item, {
            [s.chat_modal_main__list_item__selected]:
              selectedItem === SelectedItem.Docs,
          })}
        >
          Docs
        </li>
